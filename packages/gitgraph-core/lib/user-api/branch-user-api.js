...
import { createDeletedBranch } from "../branch";
import { withoutUndefinedKeys } from "../utils";
export { BranchUserApi };
class BranchUserApi {
    ...
    merge(...args) {
        ...
        if (fastForward && canFastForward) {
            ...
            this._commitWithParents({
                ...commitOptions,
                subject: (commitOptions && commitOptions.subject) ||
    ...
    _commitWithParents(options, parents) {
        ...
        const commit = new Commit({
            ...
            subject: this._branch.commitDefaultOptions.subject ||
