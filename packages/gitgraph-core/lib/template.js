...
export { MergeStyle, Template, TemplateName, blackArrowTemplate, metroTemplate, templateExtend, getTemplate, };
/**
...
class Template {
    constructor(options) {
        ...
        this.commit = {
            ...
            hasTooltipInCompactMode: booleanOptionOr(options.commit.hasTooltipInCompactMode, true),
            dot: {
